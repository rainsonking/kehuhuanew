...
import com.kwsoft.kehuhua.adcustom.ExampleApplication;
...
public abstract class BaseActivity extends AppCompatActivity implements IBaseActivity{
	...
	protected ExampleApplication myApplication;
...
//		getSupportActionBar().hide();
		...
		pg.setMessage(getResources().getString(R.string.loading));
		myApplication = (ExampleApplication) getApplication();
	...
	protected void onResume() {
		super.onResume();
		JPushInterface.onResume(myApplication);
	}

	@Override
	protected void onPause() {
		super.onPause();
		JPushInterface.onPause(myApplication);
	}
