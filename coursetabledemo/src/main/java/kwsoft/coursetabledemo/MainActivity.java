...
public class MainActivity extends AppCompatActivity implements OnDataListener,WeekDateChaListener {
...
//                        .LENGTH_SHORT).show();
                ...
                RelativeLayout.LayoutParams layoutParams=new RelativeLayout.LayoutParams((int)courseInfoWidth,dip2px(MainActivity.this,2));
                layoutParams.setMargins((int)marginLeft,dip2px(MainActivity.this,64),0,0);
                ...
                if (selectView == null) {
                    selectView = new View(MainActivity.this);
                ...
                if (selectViewButtom == null) {
                    selectViewButtom = new View(MainActivity.this);
