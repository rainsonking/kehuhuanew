...
public class RowsAddActivity extends AppCompatActivity {
    ...
    PullToRefreshListView rowsLvAddItem;
    ...
    private void init() {
        ...
        paramsMap.put(Constant.mainId, Constant.mainIdValue);
    ...
    private void getIntentData() {
        ...
        Log.e("TAG", "关联添加按钮数据： " +buttonSetItemStr);
...
//获取默认值
            defaultValArr = (Map<String, String>) buttonSet.get("dataInfo");
//获取fieldSet
...
//展示数据
        if (fieldSet != null && fieldSet.size() > 0) {
            ...
            rowsLvAddItem.setAdapter(addAdapter);
        }
    ...
    public class AddAdapter extends BaseAdapter {
        ...
        public AddAdapter() {
            Log.e("TAG", "添加适配器监测点1");
            mInflater = LayoutInflater.from(RowsAddActivity.this);
        }
...
//                    fieldSet.get(position).put("tempValue", defaultName);
                ...
                Log.e("TAG","所在位置 "+position+"  position");
//2、单值选择项&星期
                Log.e("TAG", "添加适配器监测点5");
                ...
                SimpleAdapter simpleAdapter = new SimpleAdapter(RowsAddActivity.this,
                ...
                fieldSet.get(position).put("tempValue", byId);
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = DatePickerDialog.newInstance((new DatePickerDialog.OnDateSetListener() {
                                    ...
                                    public void onDateSet(DatePickerDialog datePickerDialog, int year, int month, int day) {
                                        addGeneral.setText(year + "-" + (month+1)+ "-" + day);
                                        fieldSet.get(position).put("tempValue", year + "-" + (month+1) + "-" + day);
                                    }
                                }),
                                c.get(Calendar.YEAR),
                        ...
                        TimePickerDialog timePickerDialog = TimePickerDialog.newInstance(
                                (new TimePickerDialog.OnTimeSetListener() {
                                    ...
                                    public void onTimeSet(RadialPickerLayout view, int hour, int minute) {
                                        Toast.makeText(RowsAddActivity.this, "选择后的" + hour + "分钟" + minute, Toast.LENGTH_SHORT).show();
                                        addGeneral.setText(hour + ":" + minute);
                                        fieldSet.get(position).put("tempValue",hour + ":" + minute);
                                    }
                ...
                addGeneral.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (finalChooseType !=1) {
                            ...
                            toTreeViewActivity("false", idArrs, multiValueData);
                        }
...
//6、内部对象多值
        ...
        public void toMultiValueActivity(String isMulti, String idArrs, String multiValueData) {
            ...
            intent.setClass(RowsAddActivity.this, MultiValueActivity.class);
            Constant.jumpNum=3;
        ...
        public void toTreeViewActivity(String isMulti, String idArrs, String multiValueData) {
            Intent intent = new Intent();
            Log.e("TAG", "内部对象多值检查点3");
            intent.setClass(RowsAddActivity.this, TreeViewActivity.class);
            Constant.jumpNum=3;
            Log.e("TAG", "内部对象多值检查点4");
            intent.putExtra("multiValueData", multiValueData);
            intent.putExtra("idArrs", idArrs);
